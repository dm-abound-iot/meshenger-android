...
*/
  ...
  */
   ...
   */
  public abstract class TCPChannelClient extends Thread {
    private static final String TAG = "TCPChannelClient";
    ...
    TCPChannelClient(ExecutorService executor, TCPChannelEvents eventListener) {
      this.executor = executor;
  ...
  public static class TCPSocketServer extends TCPChannelClient {
    // Server socket is also guarded by rawSocketLock.
    @Nullable
    private ServerSocket serverSocket;

    public TCPSocketServer(ExecutorService executor, TCPChannelEvents eventListener) {
    ...
    public Socket connect() {
      ...
      try {
        tempSocket = new ServerSocket(12345, 0);
      } catch (IOException e) {
  ...
  public static class TCPSocketClient extends TCPChannelClient {
    final private String address;
    final private int port;

    public TCPSocketClient(ExecutorService executor, TCPChannelEvents eventListener, String address, int port) {
      super(executor, eventListener);
