...
public class PeerConnectionClient {
  ...
  public void createPeerConnection1(final VideoSink localRender, final VideoSink remoteSink,
  ...
  public void createPeerConnection2(final VideoSink localRender, final List<VideoSink> remoteSinks,
      final VideoCapturer videoCapturer, final List<PeerConnection.IceServer> iceServers) {
...
*/
  ...
  private void createMediaConstraintsInternal() {
    ...
    sdpMediaConstraints.mandatory.add(new MediaConstraints.KeyValuePair(
        "OfferToReceiveAudio", Boolean.toString(peerConnectionParameters.playAudio))); //"true"));
    sdpMediaConstraints.mandatory.add(new MediaConstraints.KeyValuePair(
        "OfferToReceiveVideo", Boolean.toString(peerConnectionParameters.playVideo))); // isVideoCallEnabled())));
  }
